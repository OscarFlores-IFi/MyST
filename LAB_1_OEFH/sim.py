...
###############################################################################
[punt,padres,hist_mean,hist_std,hist_cal,hist_padres] = pickle.load(open('Intento3.sav','rb'))

#%% Simulamos

l_vec = len(model_close)**len(ndias) # longitud de cada vector de toma de decisiones
n_vec = 128 # cantidad de vectores de toma de decisiones por generacion en potencias de 2.
iteraciones = 100
